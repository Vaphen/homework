...
namespace HelpDialogs {
	...
	static std::string showExecutableChooser(const std::string &title) {
		...
		executableFilter->add_mime_type("application/exe");
		executableFilter->add_mime_type("application/octet-stream");
		executableFilter->add_mime_type("application/x-msdownload");
		executableFilter->add_mime_type("application/x-exe");
		executableFilter->add_mime_type("application/dos-exe");
		executableFilter->add_mime_type("vms/exe");
		executableFilter->add_mime_type("application/x-winexe");
		executableFilter->add_mime_type("application/msdos-windows");
		executableFilter->add_mime_type("application/x-msdos-program");
